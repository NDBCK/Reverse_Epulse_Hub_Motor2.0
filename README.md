...
-DRV8323RS: 3-phase smart gate driver to control the power stage
...
-Serial UART console! (Three terminal pins: GND, PB6 USART1 TX, PB7 USART1 RX)
...
The firmware stil has breakpoints left.
